...
const file_atelet_proto_rawDesc = "" +
	...
	"\x19SNAPSHOT_SCOPE_FILESYSTEM\x10\x042\xb1\x02\n" +
	"\fAteomSupport\x12c\n" +
...
var file_atelet_proto_goTypes = []any{
	...
	(*ReclaimActorRequest)(nil),             // 9: atelet.ReclaimActorRequest
	(*ReclaimActorResponse)(nil),            // 10: atelet.ReclaimActorResponse
	(*DropSnapshotMemoryRequest)(nil),       // 11: atelet.DropSnapshotMemoryRequest
	(*DropSnapshotMemoryResponse)(nil),      // 12: atelet.DropSnapshotMemoryResponse
	...
	(*ateapipb.WorkerResources)(nil),        // 50: ateapi.WorkerResources
}
var file_atelet_proto_depIdxs = []int32{
	50, // 0: atelet.SetWorkerCapacityRequest.capacity:type_name -> ateapi.WorkerResources
	20, // 1: atelet.TerminateRequest.spec:type_name -> atelet.WorkloadSpec
	20, // 2: atelet.RunRequest.spec:type_name -> atelet.WorkloadSpec
	19, // 3: atelet.RunRequest.sandbox_assets:type_name -> atelet.SandboxAssets
	16, // 4: atelet.RunRequest.egress_gateway:type_name -> atelet.EgressGateway
	47, // 5: atelet.ArchAssets.files:type_name -> atelet.ArchAssets.FilesEntry
	48, // 6: atelet.SandboxAssets.assets:type_name -> atelet.SandboxAssets.AssetsEntry
	31, // 7: atelet.WorkloadSpec.containers:type_name -> atelet.Container
	29, // 8: atelet.WorkloadSpec.volumes:type_name -> atelet.Volume
	49, // 9: atelet.ExternalVolumeSource.volume_context:type_name -> atelet.ExternalVolumeSource.VolumeContextEntry
	0,  // 10: atelet.ActorMetadataItem.field:type_name -> atelet.ActorMetadataField
	24, // 11: atelet.ActorMetadataDataSource.items:type_name -> atelet.ActorMetadataItem
	25, // 12: atelet.SystemInfoDataSource.actor_metadata:type_name -> atelet.ActorMetadataDataSource
	26, // 13: atelet.SystemInfoDataSource.trust_bundle:type_name -> atelet.TrustBundleDataSource
	27, // 14: atelet.SystemInfoVolume.data_sources:type_name -> atelet.SystemInfoDataSource
	21, // 15: atelet.Volume.durable_dir:type_name -> atelet.DurableDirVolume
	22, // 16: atelet.Volume.external:type_name -> atelet.ExternalVolumeSource
	28, // 17: atelet.Volume.system_info:type_name -> atelet.SystemInfoVolume
	23, // 18: atelet.Volume.image:type_name -> atelet.ImageVolumeSource
	35, // 19: atelet.Container.env:type_name -> atelet.EnvEntry
	36, // 20: atelet.Container.wakeup_probe:type_name -> atelet.WakeupProbe
	30, // 21: atelet.Container.volume_mounts:type_name -> atelet.VolumeMount
	32, // 22: atelet.Container.security_context:type_name -> atelet.SecurityContext
	34, // 23: atelet.Container.resources:type_name -> atelet.ResourceLimits
	33, // 24: atelet.SecurityContext.capabilities:type_name -> atelet.Capabilities
	37, // 25: atelet.WakeupProbe.http_get:type_name -> atelet.HTTPGetAction
	20, // 26: atelet.CheckpointRequest.spec:type_name -> atelet.WorkloadSpec
	1,  // 27: atelet.CheckpointRequest.type:type_name -> atelet.CheckpointType
	39, // 28: atelet.CheckpointRequest.local_config:type_name -> atelet.LocalCheckpointConfiguration
	40, // 29: atelet.CheckpointRequest.external_config:type_name -> atelet.ExternalCheckpointConfiguration
	...
	20, // 32: atelet.RestoreRequest.spec:type_name -> atelet.WorkloadSpec
	1,  // 33: atelet.RestoreRequest.type:type_name -> atelet.CheckpointType
	39, // 34: atelet.RestoreRequest.local_config:type_name -> atelet.LocalCheckpointConfiguration
	40, // 35: atelet.RestoreRequest.external_config:type_name -> atelet.ExternalCheckpointConfiguration
	2,  // 36: atelet.RestoreRequest.scope:type_name -> atelet.SnapshotScope
	16, // 37: atelet.RestoreRequest.egress_gateway:type_name -> atelet.EgressGateway
	17, // 38: atelet.ArchAssets.FilesEntry.value:type_name -> atelet.AssetFile
	18, // 39: atelet.SandboxAssets.AssetsEntry.value:type_name -> atelet.ArchAssets
	...
	15, // 43: atelet.AteomHerder.Run:input_type -> atelet.RunRequest
	41, // 44: atelet.AteomHerder.Checkpoint:input_type -> atelet.CheckpointRequest
	45, // 45: atelet.AteomHerder.Restore:input_type -> atelet.RestoreRequest
	43, // 46: atelet.AteomHerder.UploadPausedCheckpoint:input_type -> atelet.UploadPausedCheckpointRequest
	13, // 47: atelet.AteomHerder.Terminate:input_type -> atelet.TerminateRequest
	11, // 48: atelet.AteomHerder.DropSnapshotMemory:input_type -> atelet.DropSnapshotMemoryRequest
	9,  // 49: atelet.AteomHerder.ReclaimActor:input_type -> atelet.ReclaimActorRequest
	...
	38, // 53: atelet.AteomHerder.Run:output_type -> atelet.RunResponse
	42, // 54: atelet.AteomHerder.Checkpoint:output_type -> atelet.CheckpointResponse
	46, // 55: atelet.AteomHerder.Restore:output_type -> atelet.RestoreResponse
	44, // 56: atelet.AteomHerder.UploadPausedCheckpoint:output_type -> atelet.UploadPausedCheckpointResponse
	14, // 57: atelet.AteomHerder.Terminate:output_type -> atelet.TerminateResponse
	12, // 58: atelet.AteomHerder.DropSnapshotMemory:output_type -> atelet.DropSnapshotMemoryResponse
	10, // 59: atelet.AteomHerder.ReclaimActor:output_type -> atelet.ReclaimActorResponse
